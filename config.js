...
FOOTER: process.env.FOOTER === undefined ? 'ᴊᴀɴɪʏᴀ-ᴍᴅ ᴘᴜʙʟɪᴄ ꜱᴛᴀʙʟᴇ' : process.env.FOOTER,
CAPTION: process.env.CAPTION === undefined ? '*ɢᴇɴᴀʀᴀᴛᴇᴅ ʙʏ ᴊᴀɴɪʏᴀ-ᴍᴅ*' : process.env.CAPTION,
